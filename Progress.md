...
With the face detection giving a bounding box for the face itelf, I was able to grab the image of the face alone in order to perform an Emotion Recognition function. While there was much less sources for Emotion Recognition, I found another open source project called [FrontEnd-EmotionDetection](https://github.com/kevinisbest/FrontEnd-EmotionDetection) with a pre-trained model for TensorFlow.js. The implementation can be seen [here](https://github.com/ryanknauer/CPSC448/blob/b6fed5b75f8f1bb9c650517e8365b16d1cef5bc2/YoutubeExtension/testing.js#L114) 
